...
describe("Pruebas Controlador ", () => {
    ...
    describe("Verificacion Posicion Inicial 1,2O giro derecha e izquierda", () => {
        it ("Posicion Inicial Correcta hacia la derecha", () => {
            expect(controlador("5,5/1,2O/D")).toEqual("1,2N");
        });
        it ("Posicion Inicial Correcta hacia la izquierda", () => {
            expect(controlador("5,5/1,2O/I")).toEqual("1,2S");
        });
    });
});